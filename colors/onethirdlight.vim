" ==============================================================================
"   Name:        One Q̶u̶a̶r̶t̶e̶r̶ Third Light
"   Author:      Jonatan Degus, remixed by Eric Reber & Edward Bickley
"   Url:         https://degus.no
"   License:     BigDog License
"
"   A lighter vim color scheme based on a light vim color scheme based on A̶t̶o̶m̶'s̶ O̶n̶e̶ whatever came to mind
...
let g:colors_name="onethirdlight"
let colors_name="onethirdlight"


let s:black       = { "gui": "#383a42", "cterm": "237" }
let s:red         = { "gui": "#d91254", "cterm": "161" }
let s:green       = { "gui": "#0ebd0b", "cterm": "34" }
let s:lightgreen  = { "gui": "#00ae8b", "cterm": "36" } 
let s:yellow      = { "gui": "#c18401", "cterm": "18" }
let s:blue        = { "gui": "#0795d2", "cterm": "32" }
let s:pink        = { "gui": "#f906bf", "cterm": "199" } 
